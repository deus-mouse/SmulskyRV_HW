...
public class DataStorageAndWorkingWithFilesActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_storage_and_working_with_files);
    }
    ...
    void writeFileSD() {
        ...
        try {
            ...
            // пишем данные
            bw.write("Содержимое файла на SD");       // закрываем поток
            bw.close();
    ...
    void readFileSD() {
        ...
        if (!Environment.getExternalStorageState().equals(
                Environment.MEDIA_MOUNTED)) { Log.d(LOG_TAG, "SD-карта не доступна: "+Environment.getExternalStorageState());
            return;
        }
        ...
        try {
            ...
            String str = "";
            while ((str = br.readLine()) != null) {// читаем содержимое
                Log.d(LOG_TAG, str);
            }
        } catch (FileNotFoundException e) {
            e.printStackTrace();
